 ...
 */
bool RegisterSyncRequest(const FileTag *fileTag,
    ...
    if (pendingOps != NULL) {
        ...
        RememberSyncRequest(fileTag, syncRequestType);
        return true;
    }
