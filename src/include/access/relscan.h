...
// Generic descriptor for table scans 目前已知的子类是 HeapScanDescData
typedef struct TableScanDescData {
    ...
    // information about type and behaviour of the scan, a bitmask of members of the ScanOptions enum (see tableam.h).
    uint32 rs_flags;
