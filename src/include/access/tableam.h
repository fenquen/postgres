...
typedef struct TableAmRoutine {
    ...
    /*
     * Start a scan on `relation`.  The callback has to return a TableScanDesc,
    ...
    // Return next tuple from `scan`, the result is store in slot.
    ...
    /* ------------------------------------------------------------------------
     * dml Manipulations of physical tuples
     * ------------------------------------------------------------------------
     */
