...
typedef struct XLogRecord {
    ...
    // the belonging are XLogRecordBlockHeaders and XLogRecordDataHeader following with no padding
} XLogRecord;
...
typedef struct XLogRecordBlockImageHeader {
    ...
    uint16 hole_offset;    /* number of bytes before "hole" 对应 page的lower*/
...
typedef struct XLogRecordBlockCompressHeader {
    uint16 hole_length;    /* number of bytes in "hole"对应了page的upper-lower */
