 ...
 *
 * functions is a List because we use this to represent the construct ROWS FROM(func1(...), func2(...), ...).]
 * Each element of this list is a two-element sublist
 *  the first element being the untransformed function call tree,
 *  the second element being a possibly-empty list of ColumnDef
 *  node representing any column def list attached to that function within the ROWS FROM() syntax.
 *
...
typedef enum RTEKind {
    ...
    RTE_SUBQUERY,                /* select from a subquery */
    RTE_JOIN,                    /* join */
    RTE_FUNCTION,                /*  select from a function */
...
/*--------------------
 * RangeTblEntry - http://blog.itpub.net/6906/viewspace-2648129/
 *	  A range table is a List of RangeTblEntry
 *
