...
/* GUC variables */
extern PGDLLIMPORT int old_snapshot_threshold; // 对应了配置 old_snapshot_threshold 默认是-1不使用
...
extern void PushActiveSnapshotWithLevel(Snapshot snapshot, int snapshotLevel);
